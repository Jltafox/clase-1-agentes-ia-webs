...
- URLs en kebab-case y en español: `/magia-infantil/`, `/eventos-empresa/`.
...
2. **Alcance cerrado**: magia infantil + eventos de empresa. NO comuniones. NO escuela online (Método Furni se menciona solo como credencial en la bio).
